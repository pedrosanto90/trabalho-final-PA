...
def create_tables():
    ...
    mycursor.execute('CREATE TABLE services (services_id INT AUTO INCREMENT PRIMARY KEY, \
    ...
    payment_service_id INT, payment_date DATE, payment_value INT,\
    ...
    mycursor.execute('CREATE TABLE payment_states (payment_state_id INT AUTO_INCREMENT PRUIMARY KEY, \
